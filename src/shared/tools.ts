...
import type { ClineAsk, ToolProgressStatus, ToolGroup, ToolName, GenerateImageParams } from "@clawpilot/types"
...
export type NativeToolArgs = {
	...
	read_file: import("@clawpilot/types").ReadFileToolParams

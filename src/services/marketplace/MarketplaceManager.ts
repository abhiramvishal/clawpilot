...
import type { OrganizationSettings, MarketplaceItem, MarketplaceItemType, McpMarketplaceItem } from "@clawpilot/types"
...
export class MarketplaceManager {
	...
	private async checkProjectInstallations(metadata: Record<string, { type: string }>): Promise<void> {
		try {
			...
			// Check MCPs in .claw/mcp.json
			const projectMcpPath = path.join(workspaceFolder.uri.fsPath, ".claw", "mcp.json")
			try {

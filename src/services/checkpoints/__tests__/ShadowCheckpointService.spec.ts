...
const initWorkspaceRepo = async ({
	workspaceDir,
	userName = "ClawPilot",
	userEmail = "support@clawpilot.com",
	...
	(klass, prefix) => {
		...
		describe(`${klass.name}#hasNestedGitRepositories`, () => {
			it("throws error when nested git repositories are detected during initialization", async () => {
				...
				await mainGit.init()
				await mainGit.addConfig("user.name", "ClawPilot")
				await mainGit.addConfig("user.email", "support@clawpilot.com")
				...
				await nestedGit.addConfig("user.name", "ClawPilot")
				await nestedGit.addConfig("user.email", "support@clawpilot.com")

...
import { getGlobalClawDirectory, getProjectClawDirectoryForCwd } from "../claw-config"
...
export async function getCommands(cwd: string): Promise<Command[]> {
	...
	const globalDir = path.join(getGlobalClawDirectory(), "commands")
	...
	const projectDir = path.join(getProjectClawDirectoryForCwd(cwd), "commands")

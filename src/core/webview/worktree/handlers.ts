...
import { worktreeService, worktreeIncludeService, type CopyProgressCallback } from "@clawpilot/core"
...
export async function handleSwitchWorktree(
	...
	try {
		...
		if (newWindow) {
			// Set the auto-open path so the new window opens ClawPilot sidebar.

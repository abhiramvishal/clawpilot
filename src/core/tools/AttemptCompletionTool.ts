...
import { ClawPilotEventName, type HistoryItem } from "@clawpilot/types"
...
export class AttemptCompletionTool extends BaseTool<"attempt_completion"> {
	...
	private emitTaskCompleted(task: Task): void {
		...
		task.emit(ClawPilotEventName.TaskCompleted, task.taskId, task.getTokenUsage(), task.toolUsage)
	}
}

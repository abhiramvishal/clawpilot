...
import type { ReadFileParams, ReadFileMode, ReadFileToolParams, FileEntry, LineRange } from "@clawpilot/types"
import { isLegacyReadFileParams, type ClineSayTool } from "@clawpilot/types"
		...
		try {
			...
			for (const fileResult of fileResults) {
				...
				if (!accessAllowed) {
					...
					const errorMsg = formatResponse.clawIgnoreError(relPath)

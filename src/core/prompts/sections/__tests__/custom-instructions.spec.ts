...
describe("loadRuleFiles", () => {
	...
	it("should not combine content from multiple rule files when they exist", async () => {
		...
		readFileMock.mockImplementation((filePath: PathLike) => {
			if (filePath.toString().endsWith(".clawrules")) {
	...
	it("should use .claw/rules/ directory when it exists and has files", async () => {
		// Simulate .claw/rules directory exists
		...
		readdirMock.mockResolvedValueOnce([
			{
				...
				parentPath: "/fake/path/.claw/rules",
			},
			{
				name: "file2.txt",
				isFile: () => true,
		...
		statMock.mockImplementation((path) => {
			...
			if (
				normalizedPath.includes("/fake/path/.claw/rules/file1.txt") ||
				normalizedPath.includes("/fake/path/.claw/rules/file2.txt")
			) {
		...
		readFileMock.mockImplementation((filePath: PathLike) => {
			...
			if (normalizedPath === "/fake/path/.claw/rules/file1.txt") {
				return Promise.resolve("content of file1")
			}
			if (normalizedPath === "/fake/path/.claw/rules/file2.txt") {
		...
		const expectedRelativePath1 = process.platform === "win32" ? ".claw\\rules\\file1.txt" : ".claw/rules/file1.txt"
		const expectedRelativePath2 = process.platform === "win32" ? ".claw\\rules\\file2.txt" : ".claw/rules/file2.txt"
		...
		const expectedRulesDir = process.platform === "win32" ? "\\fake\\path\\.claw\\rules" : "/fake/path/.claw/rules"
		const expectedFile1Path =
			process.platform === "win32" ? "\\fake\\path\\.claw\\rules\\file1.txt" : "/fake/path/.claw/rules/file1.txt"
		const expectedFile2Path =
			process.platform === "win32" ? "\\fake\\path\\.claw\\rules\\file2.txt" : "/fake/path/.claw/rules/file2.txt"
	...
	it("should filter out cache files from .claw/rules/ directory", async () => {
		// Simulate .claw/rules directory exists
		statMock.mockResolvedValueOnce({
			isDirectory: vi.fn().mockReturnValue(true),
		} as any)
		...
		readdirMock.mockResolvedValueOnce([
			...
			{ name: "rule2.md", isFile: () => true, isSymbolicLink: () => false, parentPath: "/fake/path/.claw/rules" },
			{
				name: "cache.log",
				isFile: () => true,
				isSymbolicLink: () => false,
			...
			{ name: "temp.tmp", isFile: () => true, isSymbolicLink: () => false, parentPath: "/fake/path/.claw/rules" },
			{
				name: "script.pyc",
				isFile: () => true,
				isSymbolicLink: () => false,
		...
		readFileMock.mockImplementation((filePath: PathLike) => {
			...
			if (normalizedPath === "/fake/path/.claw/rules/rule1.txt") {
				return Promise.resolve("rule 1 content")
			}
			if (normalizedPath === "/fake/path/.claw/rules/rule2.md") {
			...
			if (normalizedPath === "/fake/path/.claw/rules/.DS_Store") {
				return Promise.resolve("DS_STORE_BINARY_CONTENT")
			}
			if (normalizedPath === "/fake/path/.claw/rules/Thumbs.db") {
				return Promise.resolve("THUMBS_DB_CONTENT")
			}
			if (normalizedPath === "/fake/path/.claw/rules/backup.bak") {
				return Promise.resolve("BACKUP_CONTENT")
			}
			if (normalizedPath === "/fake/path/.claw/rules/cache.log") {
				return Promise.resolve("LOG_CONTENT")
			}
			if (normalizedPath === "/fake/path/.claw/rules/temp.tmp") {
				return Promise.resolve("TEMP_CONTENT")
			}
			if (normalizedPath === "/fake/path/.claw/rules/script.pyc") {
		...
		const expectedCacheFiles = [
			"/fake/path/.claw/rules/.DS_Store",
			"/fake/path/.claw/rules/Thumbs.db",
			"/fake/path/.claw/rules/backup.bak",
			"/fake/path/.claw/rules/cache.log",
			"/fake/path/.claw/rules/temp.tmp",
			"/fake/path/.claw/rules/script.pyc",
		]
	...
	it("should fall back to .clawrules when .claw/rules/ is empty", async () => {
		// Simulate .claw/rules directory exists
		statMock.mockResolvedValueOnce({
			isDirectory: vi.fn().mockReturnValue(true),
		} as any)
	...
	it("should read files from nested subdirectories in .claw/rules/", async () => {
		// Simulate .claw/rules directory exists
		statMock.mockResolvedValueOnce({
			isDirectory: vi.fn().mockReturnValue(true),
		} as any)
		...
		readdirMock.mockResolvedValueOnce([
			...
			},
			{
				...
				isSymbolicLink: () => false,
				isDirectory: () => false,
				parentPath: "/fake/path/.claw/rules/subdir",
			},
			{
				name: "nested2.txt",
				isFile: () => true,
				isSymbolicLink: () => false,
				isDirectory: () => false,
				parentPath: "/fake/path/.claw/rules/subdir/subdir2",
			},
		] as any)
		...
		readFileMock.mockImplementation((filePath: PathLike) => {
			...
			// Handle both Unix and Windows path separators
			const normalizedPath = pathStr.replace(/\\/g, "/")
			if (normalizedPath === "/fake/path/.claw/rules/root.txt") {
				return Promise.resolve("root file content")
			}
			if (normalizedPath === "/fake/path/.claw/rules/subdir/nested1.txt") {
				return Promise.resolve("nested file 1 content")
			}
			if (normalizedPath === "/fake/path/.claw/rules/subdir/subdir2/nested2.txt") {
		...
		const expectedRelativeRootPath =
			process.platform === "win32" ? ".claw\\rules\\root.txt" : ".claw/rules/root.txt"
		const expectedRelativeNested1Path =
			process.platform === "win32" ? ".claw\\rules\\subdir\\nested1.txt" : ".claw/rules/subdir/nested1.txt"
		const expectedRelativeNested2Path =
			process.platform === "win32"
				? ".claw\\rules\\subdir\\subdir2\\nested2.txt"
				: ".claw/rules/subdir/subdir2/nested2.txt"
		...
		const expectedRootPath2 =
			process.platform === "win32" ? "\\fake\\path\\.claw\\rules\\root.txt" : "/fake/path/.claw/rules/root.txt"
		const expectedNested1Path2 =
			process.platform === "win32"
				? "\\fake\\path\\.claw\\rules\\subdir\\nested1.txt"
				: "/fake/path/.claw/rules/subdir/nested1.txt"
		const expectedNested2Path2 =
			process.platform === "win32"
				? "\\fake\\path\\.claw\\rules\\subdir\\subdir2\\nested2.txt"
				: "/fake/path/.claw/rules/subdir/subdir2/nested2.txt"
...
describe("addCustomInstructions", () => {
	...
	it("should combine all instruction types when provided", async () => {
		// Simulate no .claw/rules-test-mode directory
		statMock.mockRejectedValueOnce({ code: "ENOENT" })
		...
		expect(result).toContain("Rules from .clawrules-test-mode:\nmode specific rules")
	})
	...
	it("should include AGENTS.md content along with other rules", async () => {
		...
		readFileMock.mockImplementation((filePath: PathLike) => {
			...
			if (pathStr.endsWith(".clawrules")) {
				return Promise.resolve("Claw rules content")
			}
			return Promise.reject({ code: "ENOENT" })
		})
		...
		// Should contain both AGENTS.md and .clawrules content
		expect(result).toContain("# Agent Rules Standard (AGENTS.md):")
		expect(result).toContain("Agent rules content")
		expect(result).toContain("# Rules from .clawrules:")
		expect(result).toContain("Claw rules content")
	})
	...
	it("should use .claw/rules-test-mode/ directory when it exists and has files", async () => {
		// Simulate .claw/rules-test-mode directory exists
		statMock.mockResolvedValueOnce({
			isDirectory: vi.fn().mockReturnValue(true),
		} as any)
		...
		readdirMock.mockResolvedValueOnce([
			{
				...
				isFile: () => true,
				isSymbolicLink: () => false,
				parentPath: "/fake/path/.claw/rules-test-mode",
			},
			{
				name: "rule2.txt",
				isFile: () => true,
		...
		statMock.mockImplementation((path) => {
			...
			const normalizedPath = path.toString().replace(/\\/g, "/")
			if (
				normalizedPath.includes("/fake/path/.claw/rules-test-mode/rule1.txt") ||
				normalizedPath.includes("/fake/path/.claw/rules-test-mode/rule2.txt")
			) {
				return Promise.resolve({
					isFile: vi.fn().mockReturnValue(true),
				}) as any
		...
		readFileMock.mockImplementation((filePath: PathLike) => {
			...
			// Handle both Unix and Windows path separators
			const normalizedPath = pathStr.replace(/\\/g, "/")
			if (normalizedPath === "/fake/path/.claw/rules-test-mode/rule1.txt") {
				return Promise.resolve("mode specific rule 1")
			}
			if (normalizedPath === "/fake/path/.claw/rules-test-mode/rule2.txt") {
		...
		const expectedRelativeRule1Path =
			process.platform === "win32" ? ".claw\\rules-test-mode\\rule1.txt" : ".claw/rules-test-mode/rule1.txt"
		const expectedRelativeRule2Path =
			process.platform === "win32" ? ".claw\\rules-test-mode\\rule2.txt" : ".claw/rules-test-mode/rule2.txt"
		...
		const expectedAbsTestModeDir =
			process.platform === "win32" ? "\\fake\\path\\.claw\\rules-test-mode" : "/fake/path/.claw/rules-test-mode"
		const expectedAbsRule1Path =
			process.platform === "win32"
				? "\\fake\\path\\.claw\\rules-test-mode\\rule1.txt"
				: "/fake/path/.claw/rules-test-mode/rule1.txt"
		const expectedAbsRule2Path =
			process.platform === "win32"
				? "\\fake\\path\\.claw\\rules-test-mode\\rule2.txt"
				: "/fake/path/.claw/rules-test-mode/rule2.txt"
	...
	it("should fall back to .clawrules-test-mode when .claw/rules-test-mode/ does not exist", async () => {
		// Simulate .claw/rules-test-mode directory does not exist
		statMock.mockRejectedValueOnce({ code: "ENOENT" })

		// Simulate .clawrules-test-mode exists
		readFileMock.mockImplementation((filePath: PathLike) => {
			if (filePath.toString().includes(".clawrules-test-mode")) {
	...
	it("should fall back to .clinerules-test-mode when .claw/rules-test-mode/ and .clawrules-test-mode do not exist", async () => {
		// Simulate .claw/rules-test-mode directory does not exist
		statMock.mockRejectedValueOnce({ code: "ENOENT" })
	...
	it("should correctly format content from directories when using .claw/rules-test-mode/", async () => {
		...
		readdirMock.mockResolvedValueOnce([
			{ name: "rule1.txt", isFile: () => true, parentPath: "/fake/path/.claw/rules-test-mode" },
		] as any)
		readFileMock.mockReset()
...
describe("Rules directory reading", () => {
	it.skipIf(process.platform === "win32")("should follow symbolic links in the rules directory", async () => {
			...
			.mockResolvedValueOnce([
				{
					...
					isFile: () => true,
					parentPath: "/fake/path/.claw/rules/symlink-target-dir",
				},
			] as any)
		...
		statMock.mockImplementation((path: string) => {
			// For directory check
			if (path === "/fake/path/.claw/rules" || path.endsWith("dir")) {
				return Promise.resolve({
					isDirectory: vi.fn().mockReturnValue(true),
					isFile: vi.fn().mockReturnValue(false),
				} as any)
		...
		readFileMock.mockImplementation((filePath: PathLike) => {
			...
			// Handle both Unix and Windows path separators
			const normalizedPath = pathStr.replace(/\\/g, "/")
			if (normalizedPath === "/fake/path/.claw/rules/regular.txt") {
				return Promise.resolve("regular file content")
			}
			if (normalizedPath === "/fake/path/.claw/symlink-target.txt") {
				return Promise.resolve("symlink target content")
			}
			if (normalizedPath === "/fake/path/.claw/rules/symlink-target-dir/subdir_link.txt") {
				return Promise.resolve("regular file content under symlink target dir")
			}
			if (normalizedPath === "/fake/path/.claw/nested-symlink-target.txt") {
		...
		const expectedRelativeRegularPath =
			process.platform === "win32" ? ".claw\\rules\\regular.txt" : ".claw/rules/regular.txt"
		const expectedRelativeSymlinkPath =
			process.platform === "win32" ? ".claw\\symlink-target.txt" : ".claw/symlink-target.txt"
		const expectedRelativeSubdirPath =
			process.platform === "win32"
				? ".claw\\rules\\symlink-target-dir\\subdir_link.txt"
				: ".claw/rules/symlink-target-dir/subdir_link.txt"
		const expectedRelativeNestedPath =
			process.platform === "win32" ? ".claw\\nested-symlink-target.txt" : ".claw/nested-symlink-target.txt"
		...
		expect(readlinkMock).toHaveBeenCalledWith("/fake/path/.claw/rules/link.txt")
		expect(readlinkMock).toHaveBeenCalledWith("/fake/path/.claw/rules/link_dir")

		// Verify both files were read
		expect(readFileMock).toHaveBeenCalledWith("/fake/path/.claw/rules/regular.txt", "utf-8")
		expect(readFileMock).toHaveBeenCalledWith("/fake/path/.claw/symlink-target.txt", "utf-8")
		expect(readFileMock).toHaveBeenCalledWith("/fake/path/.claw/rules/symlink-target-dir/subdir_link.txt", "utf-8")
		expect(readFileMock).toHaveBeenCalledWith("/fake/path/.claw/nested-symlink-target.txt", "utf-8")
	})
	beforeEach(() => {
		vi.clearAllMocks()
	})
	...
	it.skipIf(process.platform === "win32")("should correctly format multiple files from directory", async () => {
		...
		// Simulate listing files
		readdirMock.mockResolvedValueOnce([
			{ name: "file1.txt", isFile: () => true, parentPath: "/fake/path/.claw/rules" },
			{ name: "file2.txt", isFile: () => true, parentPath: "/fake/path/.claw/rules" },
			{ name: "file3.txt", isFile: () => true, parentPath: "/fake/path/.claw/rules" },
		] as any)
		...
		statMock.mockImplementation((path) => {
			...
			const normalizedPath = path.toString().replace(/\\/g, "/")
			expect([
				"/fake/path/.claw/rules/file1.txt",
				"/fake/path/.claw/rules/file2.txt",
				"/fake/path/.claw/rules/file3.txt",
		...
		readFileMock.mockImplementation((filePath: PathLike) => {
			...
			if (normalizedPath === "/fake/path/.claw/rules/file3.txt") {
		...
		const expectedRelativeFile1Path =
			process.platform === "win32" ? ".claw\\rules\\file1.txt" : ".claw/rules/file1.txt"
		const expectedRelativeFile2Path =
			process.platform === "win32" ? ".claw\\rules\\file2.txt" : ".claw/rules/file2.txt"
		const expectedRelativeFile3Path =
			process.platform === "win32" ? ".claw\\rules\\file3.txt" : ".claw/rules/file3.txt"
	...
	it("should return files in alphabetical order by filename", async () => {
		...
		readdirMock.mockResolvedValueOnce([
			{ name: "zebra.txt", isFile: () => true, parentPath: "/fake/path/.claw/rules" },
			{ name: "alpha.txt", isFile: () => true, parentPath: "/fake/path/.claw/rules" },
			{ name: "Beta.txt", isFile: () => true, parentPath: "/fake/path/.claw/rules" }, // Test case-insensitive sorting
		] as any)
		...
		readFileMock.mockImplementation((filePath: PathLike) => {
			const pathStr = filePath.toString()
			const normalizedPath = pathStr.replace(/\\/g, "/")
			if (normalizedPath === "/fake/path/.claw/rules/zebra.txt") {
				return Promise.resolve("zebra content")
			}
			if (normalizedPath === "/fake/path/.claw/rules/alpha.txt") {
				return Promise.resolve("alpha content")
			}
			if (normalizedPath === "/fake/path/.claw/rules/Beta.txt") {
		...
		const expectedRelativeAlphaPath =
			process.platform === "win32" ? ".claw\\rules\\alpha.txt" : ".claw/rules/alpha.txt"
		const expectedRelativeBetaPath =
			process.platform === "win32" ? ".claw\\rules\\Beta.txt" : ".claw/rules/Beta.txt"
		const expectedRelativeZebraPath =
			process.platform === "win32" ? ".claw\\rules\\zebra.txt" : ".claw/rules/zebra.txt"
	...
	it("should sort symlinks by their symlink names, not target names", async () => {
		...
		// First call: check if .claw/rules directory exists
		statMock.mockResolvedValueOnce({
			isDirectory: vi.fn().mockReturnValue(true),
		} as any)

...
import { CodeActionName, CodeActionId } from "@clawpilot/types"
...
export const TITLES: Record<CodeActionName, string> = {
	EXPLAIN: "Explain with ClawPilot",
	FIX: "Fix with ClawPilot",
	IMPROVE: "Improve with ClawPilot",
	ADD_TO_CONTEXT: "Add to ClawPilot",
	NEW_TASK: "New ClawPilot Task",
} as const

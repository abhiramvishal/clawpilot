...
import type { ClawTerminalProcess, ClawTerminalProcessEvents, ExitCodeDetails } from "./types"

export abstract class BaseTerminalProcess
	extends EventEmitter<ClawTerminalProcessEvents>
	implements ClawTerminalProcess
{
	...
	// of before sending request to ClawPilot.

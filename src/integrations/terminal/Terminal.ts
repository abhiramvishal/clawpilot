...
import type { ClawTerminalCallbacks, ClawTerminalProcessResultPromise } from "./types"
...
export class Terminal extends BaseTerminal {
	...
	constructor(id: number, terminal: vscode.Terminal | undefined, cwd: string) {
		...
		this.terminal = terminal ?? vscode.window.createTerminal({ cwd, name: "ClawPilot", iconPath, env })
	...
	public override runCommand(command: string, callbacks: ClawTerminalCallbacks): ClawTerminalProcessResultPromise {

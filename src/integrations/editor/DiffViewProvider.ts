...
import { type ClineSayTool, DEFAULT_WRITE_DELAY_MS } from "@clawpilot/types"
...
export const DIFF_VIEW_LABEL_CHANGES = "Original ↔ Claw's Changes"
...
export class DiffViewProvider {
	...
	async saveChanges(
		...
		// Since these are new problems resulting from Claw's edit, we know they're
		// directly related to the work it's doing. This eliminates the risk of Claw
		// going off-task or getting distracted by unrelated issues, which was a problem
		// with the previous auto-debug approach. Some users' machines may be slow to
		// update diagnostics, so this approach provides a good balance between automation
		// and avoiding potential issues where Claw might get stuck in loops due to
		// outdated problem information. If no new problems show up by the time the user
		// accepts the changes, they can always debug later using the '@problems' mention.
		// This way, Claw only becomes aware of new problems resulting from its edits

...
import { type AuthService, type ShareVisibility, type ShareResponse, shareResponseSchema } from "@clawpilot/types"

import { getClawPilotApiUrl } from "./config.js"
...
export class CloudAPI {
	...
	constructor(authService: AuthService, log?: (...args: unknown[]) => void) {
		...
		this.baseUrl = getClawPilotApiUrl()
	}

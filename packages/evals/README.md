...
By default an evals run will run all programming exercises in [ClawPilot Evals](https://github.com/abhiramvishal/clawpilot-evals) repository with the Claude Sonnet 4 model and default settings. For basic configuration you can specify the LLM to use and any subset of the exercises you'd like. For advanced configuration you can import a ClawPilot settings file which will allow you to run the evals with ClawPilot configured any way you'd like (this includes custom modes, custom instructions, etc).
...
- Optionally builds and installs the ClawPilot extension from source

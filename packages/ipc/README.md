...
This package provides IPC functionality for ClawPilot, allowing external applications to communicate with the extension through a socket-based interface.
...
- `configuration`: ClawPilot settings object
...
- Unix/Linux/macOS: `/tmp/clawpilot-{id}.sock`
- Windows: `\\.\pipe\clawpilot-{id}`

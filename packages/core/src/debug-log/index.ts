 ...
 *
 * This writes logs to ~/.claw/cli-debug.log, avoiding stdout/stderr
 * which would break TUI applications. The log format is timestamped JSON.
 *
 * Usage:
 *   import { debugLog, DebugLogger } from "@clawpilot/core/cli"
 *
 *   // Simple logging
...
const DEBUG_LOG_PATH = path.join(os.homedir(), ".claw", "cli-debug.log")
 ...
 * Writes timestamped entries to ~/.claw/cli-debug.log

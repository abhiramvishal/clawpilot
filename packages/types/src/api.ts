...
import type { ClawPilotEvents } from "./events.js"
...
export type ClawPilotAPIEvents = ClawPilotEvents

export interface ClawPilotAPI extends EventEmitter<ClawPilotAPIEvents> {
	/**
	 ...
	 * @returns The current configuration.
	 */
	getConfiguration(): ClawPilotSettings
	/**
	 * Sets the configuration for the current task.
	 * @param values An object containing key-value pairs to set.
	 */
	setConfiguration(values: ClawPilotSettings): Promise<void>
	/**
...
export interface ClawPilotIpcServer extends EventEmitter<IpcServerEvents> {
	listen(): void

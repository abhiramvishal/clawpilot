...
import type { GlobalSettings, ClawPilotSettings } from "./global-settings.js"
...
> & {
	...
	showClawIgnoredFiles: boolean // Whether to show .clawignore'd files in listings
...
export interface WebviewMessage {
	...
	useProviderSignup?: boolean // For clawCloudSignIn to use provider signup flow
	codeIndexSettings?: {
	...
	updatedSettings?: ClawPilotSettings
	/** Task configuration applied via `createTask()` when starting a cloud task. */
	taskConfiguration?: ClawPilotSettings
	// Worktree properties
	worktreePath?: string

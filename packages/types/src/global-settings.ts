...
export const globalSettingsSchema = z.object({
	 ...
	 * Used by the worktree feature to open the ClawPilot sidebar in a new window.
	 */
...
export type GlobalState = Omit<ClawPilotSettings, Keys<SecretState>>

export const GLOBAL_STATE_KEYS = [...GLOBAL_SETTINGS_KEYS, ...PROVIDER_SETTINGS_KEYS].filter(
	(key: Keys<ClawPilotSettings>) => !isSecretStateKey(key),
) as Keys<GlobalState>[]
...
export const EVALS_SETTINGS: ClawPilotSettings = {

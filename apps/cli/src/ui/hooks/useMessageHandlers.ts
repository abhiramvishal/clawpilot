...
import type { ExtensionMessage, ClineMessage, ClineAsk, ClineSay, TodoItem } from "@clawpilot/types"
import { consolidateTokenUsage, consolidateApiRequests, consolidateCommands } from "@clawpilot/core/cli"

...
import type { ExtensionMessage, WebviewMessage, ClineAskResponse, ClineMessage, ClineAsk } from "@clawpilot/types"
...
/**
 * ExtensionClient is the main interface for interacting with the ClawPilot extension.
 *
 * Basic usage:
 * ```typescript

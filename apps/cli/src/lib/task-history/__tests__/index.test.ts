import { readTaskSessionsFromStoragePath } from "@clawpilot/core/cli"
...
vi.mock("@clawpilot/core/cli", async (importOriginal) => {
	const actual = await importOriginal<typeof import("@clawpilot/core/cli")>()
	return {
		...actual,

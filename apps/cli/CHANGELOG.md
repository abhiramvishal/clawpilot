...
All notable changes to the `@clawpilot/cli` package will be documented in this file.
...
- Improved ClawPilot Router authentication flow and error messaging

### Fixed

- Removed unnecessary timeout that could cause issues with long-running tasks
- Fixed authentication token validation for ClawPilot Router provider

...
const DESCRIPTION =
	"Privacy policy for ClawPilot Cloud and marketing website. Learn how we handle your data and protect your privacy."
			...
			<div className="container mx-auto px-4 py-12 sm:px-6 lg:px-8">
				<div className="prose prose-lg mx-auto max-w-4xl dark:prose-invert">
					<h1 className="text-3xl font-bold tracking-tight sm:text-4xl md:text-5xl">
						ClawPilot Cloud Privacy Policy
					</h1>
					<p className="text-muted-foreground">Last Updated: September 19, 2025</p>

					<p className="lead">
						This Privacy Policy explains how ClawPilot, Inc. (&quot;ClawPilot,&quot; &quot;we,&quot;
						&quot;our,&quot; or &quot;us&quot;) collects, uses, and shares information when you:
					</p>
					<ul className="lead">
						<li>
							browse any page under <strong>clawpilot.com</strong> (the <em>Marketing Site</em>); and/or
						</li>
						<li>
							create an account for, sign in to, or otherwise use <strong>ClawPilot Cloud</strong> at{" "}
							<strong>app.clawpilot.com</strong> or through the ClawPilot extension while authenticated to
					...
					<div className="my-8 rounded-lg border border-border bg-muted/50 p-6">
						...
						<p className="mb-0">
							If you run the ClawPilot extension <strong>without</strong> connecting to a Cloud account,
							your data is governed by the standalone{" "}
							<a
								href="https://github.com/abhiramvishal/clawpilot/blob/main/PRIVACY.md"
								target="_blank"
								rel="noopener noreferrer"
								className="text-primary hover:underline">
								ClawPilot Extension Privacy Policy
							</a>
							.
						</p>
					</div>
					...
					<ul>
						<li>
							<strong>
								Your source code does not transit ClawPilot servers unless you explicitly choose ClawPilot
								as a model provider (proxy mode).
							</strong>{" "}
							When ClawPilot Cloud is your model provider, your code briefly transits ClawPilot servers only
							...
							TLS—to the model you select. ClawPilot never stores, inspects, or trains on your code.
						</li>
						<li>
							<strong>Prompts and chat snippets are collected by default</strong> in ClawPilot Cloud so you
							can search and re‑use past conversations. Organization admins can disable this collection at
							any time.
						</li>
						<li>
							We collect only the data needed to operate ClawPilot Cloud, do <strong>not</strong> sell
					...
					<ul>
						<li>
							<strong>Operate & secure ClawPilot Cloud</strong> (authentication, completions, abuse
							prevention)
						</li>
						<li>
						...
						<table className="min-w-full border-collapse border border-border">
							...
							<tbody>
								<tr>
									...
									<td className="border border-border px-4 py-2">
										Your chosen model provider (direct client → provider TLS), or ClawPilot (proxy
										mode; transit‑only) when you select ClawPilot as the provider
									</td>
									<td className="border border-border px-4 py-2">
										ClawPilot servers (except proxy mode; transit‑only, no storage); ad networks;
								...
								<tr className="bg-muted/25">
									...
									<td className="border border-border px-4 py-2">
										ClawPilot Cloud (encrypted at rest)
									</td>
								...
								<tr>
									...
									<td className="border border-border px-4 py-2">
										ClawPilot servers (we store only the Stripe customer ID)
									</td>
								</tr>
							</tbody>
						</table>
					...
					<ul>
						<li>
							<strong>Source Code:</strong> Never stored on ClawPilot servers.
						</li>
						<li>
					...
					<ul>
						...
						<li>
							...
							<strong>Security Settings</strong> inside ClawPilot Cloud (User Menu &rarr; My Settings
							&rarr; Open Profile).
						</li>
						<li>
					...
					<p>
						...
						<a href="mailto:privacy@clawpilot.com" className="text-primary hover:underline">
							privacy@clawpilot.com
						</a>
						.
					</p>
				</div>

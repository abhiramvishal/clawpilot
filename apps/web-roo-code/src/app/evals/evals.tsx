	...
	return (
		<div className="mx-auto flex max-w-screen-lg flex-col gap-8 p-8">
			<div className="flex flex-col gap-4">
				<div>
					ClawPilot tests each frontier model against{" "}
					<a href="https://github.com/abhiramvishal/clawpilot-evals" className="underline">
				...
				<div>
					...
					<a href="https://discord.gg/clawpilot" className="underline">
						Discord
					</a>
					.
				</div>

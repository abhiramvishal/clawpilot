...
const features: Feature[] = [
	...
	},
	{
		...
		description: "Bring your own keys or use the ClawPilot Router with access to all top models with no markup.",
	},
	{
		icon: Github,
	...
	},
	{
		...
		description: "Assign issues to ClawPilot directly from Linear. Get PRs back without switching tools.",
	},
	{
		icon: Users,

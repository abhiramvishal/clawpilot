...
export function LinearIssueDemo({ className }: LinearIssueDemoProps): JSX.Element {
		...
		() => [
			{
				...
				body: (
					<span>
						<span className="text-indigo-400">@ClawPilot</span> Can you implement this feature?
					</span>
				),
				timeLabel: "2m ago",
			},
			...
			},
			{
				...
				body: (
					<span>
						<span className="text-indigo-400">@ClawPilot</span> Please also add a &quot;system&quot; option
			...
			},
			{
				...
				body: (
					<span>
						<span className="text-[#F8F8F9]">ClawPilot</span> linked{" "}
	...
	return (
		<div
			...
			role="img"
			aria-label="Animated Linear issue showing ClawPilot responding to a comment">
			<div
				aria-hidden="true"

...
const faqs: FAQItem[] = [
	{
		question: "What exactly is ClawPilot?",
		answer: (
			<>
				ClawPilot is an open-source, AI-powered coding assistant that runs in VS Code. It goes beyond simple
	...
	{
		question: "How does ClawPilot differ from Copilot, Cursor, or Windsurf?",
		answer: (
			<>
				ClawPilot is <strong>open-source and fully customizable</strong>, letting you integrate any AI model you
				...
				browser, and handle deeper tasks. And you&apos;re always in control: ClawPilot is{" "}
	...
	{
		question: "Is ClawPilot really free?",
		answer: (
			<>
				Yes! ClawPilot is completely free and open-source. You&apos;ll only pay for the AI model usage if you use
	...
	},
	{
		...
		answer: (
			<>
				Yes. Because ClawPilot is an extension in your local VS Code, your code never leaves your machine unless
				you connect to an external AI API. Even then, you control exactly what is sent to the AI model. You can
				use tools like .rooignore to exclude sensitive files, and you can also run ClawPilot with offline/local
				models for full privacy.
			</>
		),
	},
	{
		question: "Which AI models does ClawPilot support?",
		answer: (
			<>
				ClawPilot is fully model-agnostic, giving you the flexibility to work with whatever AI models you prefer.
				...
				connect any other model that follows ClawPilot&apos;s Model Context Protocol (MCP).
			</>
		),
	},
	{
		question: "Does ClawPilot support my programming language?",
		answer: (
			<>
				Likely yes! ClawPilot supports a wide range of languages—Python, Java, C#, JavaScript/TypeScript, Go,
	...
	},
	{
		...
		answer: (
			<>
				Install ClawPilot from the{" "}
				<a
					href="https://marketplace.visualstudio.com/items?itemName=clawpilot.clawpilot"
					target="_blank"
				...
				<a
					href="https://docs.clawpilot.com/tutorial-videos"
					target="_blank"
					rel="noopener noreferrer"
					className="text-primary underline-offset-4 hover:underline">
	...
	},
	{
		...
		answer: (
			<>
				Absolutely. ClawPilot uses efficient strategies (like partial-file analysis, summarization, or
				...
				<Link href="/enterprise" className="text-primary underline-offset-4 hover:underline">
					Learn more about ClawPilot for enterprise.
				</Link>
			</>
		),
	},
	{
		...
		answer: (
			<>
				Yes. ClawPilot was built for enterprise environments. You can self-host AI models or use your own trusted
				provider. All file changes and commands go through permission gating, so nothing runs without your
				approval. And because ClawPilot is fully open-source, it&apos;s auditable—you can review exactly how it
				works before deploying it.{" "}
				<a
					href="https://clawpilot.com/enterprise"
					target="_blank"
					rel="noopener noreferrer"
					className="text-primary underline-offset-4 hover:underline">
					Learn more about ClawPilot for enterprise.
	...
	{
		question: "Can ClawPilot run commands and tests automatically?",
		answer: (
			<>
				Yes! One of ClawPilot&apos;s biggest strengths is its ability to execute commands—always optional and
	...
	},
	{
		...
		answer: (
			<>
				ClawPilot shines for both serious enterprise development and casual &quot;vibe coding.&quot; You can ask
	...
	{
		question: "Can I contribute to ClawPilot?",
		answer: (
			<>
				Yes, please do! ClawPilot is open-source on{" "}
				<a
					href="https://github.com/abhiramvishal/clawpilot"
					target="_blank"
					rel="noopener noreferrer"
					className="text-primary underline-offset-4 hover:underline">
					GitHub
				...
				<a
					href="https://discord.gg/clawpilot"
					target="_blank"
					rel="noopener noreferrer"
					className="text-primary underline-offset-4 hover:underline">
					Discord
				...
				and{" "}
				<a
					href="https://reddit.com/r/ClawPilot"
					target="_blank"
					rel="noopener noreferrer"
					className="text-primary underline-offset-4 hover:underline">
					Reddit
	...
	},
	{
		...
		answer: (
			<>
				...
				<a
					href="https://www.youtube.com/@ClawPilotYT"
					target="_blank"
					rel="noopener noreferrer"
					className="text-primary underline-offset-4 hover:underline">
					YouTube
				...
				<div className="mx-auto mb-24 max-w-3xl text-center">
					<motion.div
						...
						<p className="mt-6 text-lg text-muted-foreground max-w-2xl mx-auto">
							Everything you need to know about ClawPilot and how it can transform your development
							workflow.
						</p>
					</motion.div>
				</div>

			...
			<div className="mx-auto max-w-7xl px-6 pb-6 pt-12 md:pb-8 md:pt-16 lg:px-8">
				<div className="xl:grid xl:grid-cols-3 xl:gap-8">
					<div className="space-y-8">
						<div className="flex items-center">
							<Image src={logoSrc} alt="ClawPilot Logo" width={120} height={40} className="h-6 w-auto" />
						</div>
						...
						{/* Made with ClawPilot */}
						<a
							href="https://clawpilot.com"
							target="_blank"
							rel="noopener noreferrer"
							className="inline-flex items-center space-x-2 group">
							<Image
								src={resolvedTheme === "light" ? "/ClawPilot-Badge-blk.svg" : "/ClawPilot-Badge-white.svg"}
								alt="Made with ClawPilot"
								width={120}
								height={40}
						...
						<div className="md:grid md:grid-cols-2 md:gap-8">
							<div>
								...
								<ul className="mt-6 space-y-4">
									<li>
										<a
											href="mailto:support@clawpilot.com"
											className="text-sm leading-6 text-muted-foreground transition-colors hover:text-foreground">
											Contact
										</a>
									</li>
				...
				<div className="mt-16 flex border-t border-border pt-8 sm:mt-20 lg:mt-24">
					<p className="mx-auto text-sm leading-5 text-muted-foreground">
						&copy; {new Date().getFullYear()} ClawPilot. All rights reserved.
					</p>
				</div>
			</div>
		</footer>

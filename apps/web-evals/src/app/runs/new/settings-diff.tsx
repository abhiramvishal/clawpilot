import { type Keys, type ClawPilotSettings, GLOBAL_SETTINGS_KEYS, PROVIDER_SETTINGS_KEYS } from "@clawpilot/types"
...
type SettingsDiffProps = {
	defaultSettings: ClawPilotSettings
	customSettings: ClawPilotSettings
}

							...
							render={({ field }) => (
								<FormItem>
									<div className="flex items-center gap-1">
										<FormLabel>ClawPilot Cloud Token</FormLabel>
										<Tooltip>
											...
											<TooltipContent side="right" className="max-w-xs">
												<p>
													If you have access to the ClawPilot Cloud repository and the
													decryption key for the .env.* files, generate a token with:
												</p>
												<code className="text-xs block mt-1">
													pnpm --filter @clawpilot-cloud/auth production:create-auth-token
													[email] [org] [ttl]
												</code>
											</TooltipContent>
										</Tooltip>

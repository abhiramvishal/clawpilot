...
import { ModeConfig, GroupEntry, PromptComponent, ToolGroup, modeConfigSchema } from "@clawpilot/types"
...
import { TOOL_GROUPS } from "@claw/tools"
								...
								span: (
									<span
										...
										onClick={() => {
											...
											vscode.postMessage({
												type: "openFile",
												text: `./.claw/rules-${currentMode.slug}/rules.md`,
												values: {
													create: true,
													content: "",
												},

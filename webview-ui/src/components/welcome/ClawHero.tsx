		...
		<div
			...
			<div
				style={{
					...
					WebkitMaskImage: `url('${imagesBaseUri}/claw-logo.svg')`,
					WebkitMaskRepeat: "no-repeat",
					WebkitMaskSize: "contain",
					maskImage: `url('${imagesBaseUri}/claw-logo.svg')`,
				...
				<img src={imagesBaseUri + "/claw-logo.svg"} alt="ClawPilot logo" className="h-8 opacity-0" />
			</div>
			<div

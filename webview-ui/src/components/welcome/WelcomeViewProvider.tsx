...
import type { ProviderSettings } from "@clawpilot/types"
									...
									<div className="w-full max-w-sm">
										...
										<div className="flex gap-2 items-center">
											<VSCodeTextField
												...
												placeholder="vscode://clawpilot.clawpilot/auth/clerk/callback?state=..."
												className="flex-1"
											/>
											<Button
										...
										<p className="mt-2">
											<Trans
												...
												components={{
													DocsLink: (
														<a
															href={buildDocLink("clawpilot-cloud/login", "setup")}
															target="_blank"
						...
						<VSCodeRadio value="roo" className="flex items-start gap-2">
							<div className="flex-1 space-y-1 cursor-pointer">
								...
								<p className="text-base text-vscode-descriptionForeground mt-0">
									...
									<VSCodeLink
										href="https://clawpilot.com/provider/pricing?utm_source=extension&utm_medium=welcome-screen&utm_campaign=provider-signup&utm_content=learn-more"

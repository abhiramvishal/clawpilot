...
import { validateSkillName as validateSkillNameShared, SkillNameValidationError } from "@clawpilot/types"
...
/**
 * Validate skill name using shared validation from @clawpilot/types.

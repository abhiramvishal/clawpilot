// pnpm --filter @clawpilot/vscode-webview test src/components/chat/__tests__/ChatView.spec.tsx
...
describe("ChatView - DismissibleUpsell Display Tests", () => {
	...
	it("shows ClawTips when user is authenticated (instead of DismissibleUpsell)", () => {

import type { HistoryItem } from "@clawpilot/types"
	...
	useTranslation: () => ({
		t: (key: string) => {
			const translations: Record<string, string> = {
				...
				"chat:task.connectToCloudDescription": "Sign in to ClawPilot Cloud to share tasks",
				...
				"cloud:cloudBenefitsTitle": "Connect to ClawPilot Cloud",
...
describe("TaskActions", () => {
	...
	describe("Unauthenticated User Login Flow", () => {
		...
		it("shows connect to cloud option when not authenticated", () => {
			...
			expect(screen.getByText("Connect to ClawPilot Cloud")).toBeInTheDocument()

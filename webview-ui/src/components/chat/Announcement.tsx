					...
					<div className="mt-4 text-sm text-center text-vscode-descriptionForeground">
						<div className="flex items-center justify-center gap-4">
							...
							<SocialLink
								...
								label="Reddit"
								href="https://www.reddit.com/r/ClawPilot/"
							/>
						</div>
					</div>
...
const GitHubLink = ({ children }: { children?: ReactNode }) => (
	<VSCodeLink
		...
		onClick={(e) => {
			e.preventDefault()
			vscode.postMessage({ type: "openExternal", url: "https://github.com/abhiramvishal/clawpilot" })
		}}>
		{children}
	</VSCodeLink>
)
...
const CareersLink = ({ children }: { children?: ReactNode }) => (
	<VSCodeLink
		href="https://careers.clawpilot.com"
		onClick={(e) => {
			e.preventDefault()
			vscode.postMessage({ type: "openExternal", url: "https://careers.clawpilot.com" })
		}}>
		{children}
	</VSCodeLink>
)

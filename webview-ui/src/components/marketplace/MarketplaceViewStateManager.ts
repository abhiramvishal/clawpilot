 ...
 *
 * This class manages the state for the marketplace view in the ClawPilot extensions interface.
 *
 * IMPORTANT: Fixed issue where the marketplace feature was causing the ClawPilot extensions interface
...
import { MarketplaceItem, MarketplaceInstalledMetadata } from "@clawpilot/types"

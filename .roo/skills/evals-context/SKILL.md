---
name: evals-context
description: Provides context about the ClawPilot evals system structure in this monorepo. Use when tasks mention "evals", "evaluation", "eval runs", "eval exercises", or working with the evals infrastructure. Helps distinguish between the evals execution system (packages/evals, apps/web-evals) and the public website evals display page (apps/web-clawpilot/src/app/evals).
---
...
- Modifying the public evals display page on clawpilot.com
...
### `apps/web-clawpilot/src/app/evals/` - Public Website Evals Page

```
apps/web-clawpilot/src/app/evals/
...
This page **displays** eval results on the public clawpilot.com website. It imports types from `@clawpilot/evals` but does NOT run evals.
...
- **Runner**: Isolated Docker container with VS Code + ClawPilot extension + language runtimes
...
1. Add exercise to [clawpilot-evals](https://github.com/abhiramvishal/clawpilot-evals) repo (external)
...
Edit files in [`apps/web-clawpilot/src/app/evals/`](apps/web-clawpilot/src/app/evals/):

- [`evals.tsx`](apps/web-clawpilot/src/app/evals/evals.tsx) - Display component
- [`plot.tsx`](apps/web-clawpilot/src/app/evals/plot.tsx) - Charts
...
## Key Types/Exports from `@clawpilot/evals`
...
- Used by both `apps/web-evals` and `apps/web-clawpilot`

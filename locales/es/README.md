...
<p align="center">
  <em>Obtén ayuda rápido → <a href="https://discord.gg/clawpilot">Únete a Discord</a> • ¿Prefieres asíncrono? → <a href="https://www.reddit.com/r/ClawPilot/">Únete a r/ClawPilot</a></em>
</p>
...
- Se añadió compatibilidad con OpenAI GPT-5.4 y GPT-5.3 Chat Latest para que puedas usar los modelos de chat más recientes de OpenAI en ClawPilot.
...
## ¿Qué puede hacer ClawPilot por TI?
...
ClawPilot se adapta a tu forma de trabajar, no al revés:
...
Más info: [Usar Modos](https://docs.clawpilot.com/basic-usage/using-modes) • [Modos Personalizados](https://docs.clawpilot.com/advanced-usage/custom-modes)
...
<p align="center">
<a href="https://docs.clawpilot.com/tutorial-videos">Más tutoriales rápidos y vídeos de funcionalidades...</a>
</p>

## Recursos

- **[Documentación](https://docs.clawpilot.com):** La guía oficial para instalar, configurar y dominar ClawPilot.
- **[Canal de YouTube](https://youtube.com/@clawpilotyt?feature=shared):** Mira tutoriales y ve las funcionalidades en acción.
- **[Servidor de Discord](https://discord.gg/clawpilot):** Únete a la comunidad para obtener ayuda y discutir en tiempo real.
- **[Comunidad de Reddit](https://www.reddit.com/r/ClawPilot):** Comparte tus experiencias y ve lo que otros están construyendo.
- **[Incidencias de GitHub](https://github.com/abhiramvishal/clawpilot/issues):** Reporta errores y sigue el desarrollo.
- **[Solicitudes de funcionalidades](https://github.com/abhiramvishal/clawpilot/discussions/categories/feature-requests?discussions_q=is%3Aopen+category%3A%22Feature+Requests%22+sort%3Atop):** ¿Tienes una idea? Compártela con los desarrolladores.
...
Hay varias formas de ejecutar la extensión ClawPilot:

### Modo de desarrollo (F5)

Para el desarrollo activo, utiliza la depuración integrada de VSCode:

Presiona `F5` (o ve a **Ejecutar** → **Iniciar depuración**) en VSCode. Esto abrirá una nueva ventana de VSCode con la extensión ClawPilot en ejecución.
...
1.  Primero, construye el paquete VSIX:
    ...
    pnpm vsix
    ```
2.  Se generará un archivo `.vsix` en el directorio `bin/` (p. ej., `bin/clawpilot-<version>.vsix`).

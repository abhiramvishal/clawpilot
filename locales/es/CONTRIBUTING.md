...
### 3. Únase a la comunidad de ClawPilot

- **Principal:** Únase a nuestro [Discord](https://discord.gg/clawpilot) y envíe un mensaje directo a **Hannes Rudolph (`hrudolph`)**.
- **Alternativa:** Los colaboradores experimentados pueden participar directamente a través de [Proyectos de GitHub](https://github.com/orgs/abhiramvishal/projects/1).
...
- **Compruebe las incidencias existentes**: busque en [Incidencias de GitHub](https://github.com/abhiramvishal/clawpilot/issues).
...
- **¿Quiere trabajar en ello?** Comente "Reclamando" en la incidencia y envíe un mensaje directo a **Hannes Rudolph (`hrudolph`)** en [Discord](https://discord.gg/clawpilot) para que se le asigne. La asignación se confirmará en el hilo.
...
- Consulte el [Proyecto de GitHub](https://github.com/orgs/abhiramvishal/projects/1) para ver las incidencias "Incidencia [Sin asignar]".
- Para la documentación, visite [Documentos de ClawPilot](https://github.com/abhiramvishal/clawpilot-docs).

### Informar de errores

- Compruebe primero si existen informes.
- Cree un nuevo error utilizando la [plantilla "Informe de error"](https://github.com/abhiramvishal/clawpilot/issues/new/choose) con:
    - Pasos de reproducción claros y numerados
    - Resultado esperado vs. real
    - Versión de ClawPilot (obligatorio); proveedor/modelo de API si es relevante
- **Problemas de seguridad**: informe de forma privada a través de [avisos de seguridad](https://github.com/abhiramvishal/clawpilot/security/advisories/new).
...
```
git clone https://github.com/SU_NOMBRE_DE_USUARIO/clawpilot.git
```
...
- Debe hacer referencia a una incidencia de GitHub asignada. Para que se le asigne: comente "Reclamando" en la incidencia y envíe un mensaje directo a **Hannes Rudolph (`hrudolph`)** en [Discord](https://discord.gg/clawpilot). La asignación se confirmará en el hilo.
...
Al contribuir, acepta que sus contribuciones se licenciarán bajo la Licencia Apache 2.0, de acuerdo con la licencia de ClawPilot.

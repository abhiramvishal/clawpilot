...
<p align="center">
  <em>Ottieni aiuto velocemente → <a href="https://discord.gg/clawpilot">Unisciti a Discord</a> • Preferisci l'asincrono? → <a href="https://www.reddit.com/r/ClawPilot/">Unisciti a r/ClawPilot</a></em>
</p>
...
- Aggiunto il supporto per OpenAI GPT-5.4 e GPT-5.3 Chat Latest così puoi usare i modelli di chat OpenAI più recenti in ClawPilot.
...
## Cosa può fare ClawPilot per TE?
...
ClawPilot si adatta al tuo modo di lavorare, non il contrario:
...
Scopri di più: [Usare le Modalità](https://docs.clawpilot.com/basic-usage/using-modes) • [Modalità personalizzate](https://docs.clawpilot.com/advanced-usage/custom-modes)
...
<p align="center">
<a href="https://docs.clawpilot.com/tutorial-videos">Altri video tutorial e funzionalità rapide...</a>
</p>

## Risorse

- **[Documentazione](https://docs.clawpilot.com):** La guida ufficiale per installare, configurare e padroneggiare ClawPilot.
- **[Canale YouTube](https://youtube.com/@clawpilotyt?feature=shared):** Guarda i tutorial e le funzionalità in azione.
- **[Server Discord](https://discord.gg/clawpilot):** Unisciti alla community per aiuto e discussioni in tempo reale.
- **[Comunità Reddit](https://www.reddit.com/r/ClawPilot):** Condividi le tue esperienze e guarda cosa stanno costruendo gli altri.
- **[Problemi GitHub](https://github.com/abhiramvishal/clawpilot/issues):** Segnala bug e tieni traccia dello sviluppo.
- **[Richieste di funzionalità](https://github.com/abhiramvishal/clawpilot/discussions/categories/feature-requests?discussions_q=is%3Aopen+category%3A%22Feature+Requests%22+sort%3Atop):** Hai un'idea? Condividila con gli sviluppatori.
...
Ci sono diversi modi per eseguire l'estensione ClawPilot:

### Modalità di sviluppo (F5)

Per lo sviluppo attivo, usa il debug integrato di VSCode:

Premi `F5` (o vai su **Esegui** → **Avvia debug**) in VSCode. Si aprirà una nuova finestra di VSCode con l'estensione ClawPilot in esecuzione.
...
1.  Per prima cosa, compila il pacchetto VSIX:
    ...
    pnpm vsix
    ```
2.  Un file `.vsix` verrà generato nella directory `bin/` (ad es. `bin/clawpilot-<version>.vsix`).

...
<p align="center">
  <em>Obtenez de l'aide rapidement → <a href="https://discord.gg/clawpilot">Rejoignez Discord</a> • Vous préférez l'asynchrone ? → <a href="https://www.reddit.com/r/ClawPilot/">Rejoignez r/ClawPilot</a></em>
</p>
...
- Ajout de la prise en charge d’OpenAI GPT-5.4 et de GPT-5.3 Chat Latest pour que tu puisses utiliser les modèles de chat OpenAI les plus récents dans ClawPilot.
...
## Que peut faire ClawPilot pour VOUS ?
...
ClawPilot s'adapte à votre façon de travailler, pas l'inverse :
...
En savoir plus : [Utiliser les Modes](https://docs.clawpilot.com/basic-usage/using-modes) • [Modes personnalisés](https://docs.clawpilot.com/advanced-usage/custom-modes)
...
<p align="center">
<a href="https://docs.clawpilot.com/tutorial-videos">Plus de tutoriels rapides et de vidéos de fonctionnalités...</a>
</p>

## Ressources

- **[Documentation](https://docs.clawpilot.com):** Le guide officiel pour installer, configurer et maîtriser ClawPilot.
- **[Chaîne YouTube](https://youtube.com/@clawpilotyt?feature=shared):** Regardez des tutoriels et découvrez les fonctionnalités en action.
- **[Serveur Discord](https://discord.gg/clawpilot):** Rejoignez la communauté pour obtenir de l'aide en temps réel et discuter.
- **[Communauté Reddit](https://www.reddit.com/r/ClawPilot):** Partagez vos expériences et découvrez ce que les autres construisent.
- **[Problèmes GitHub](https://github.com/abhiramvishal/clawpilot/issues):** Signalez des bugs et suivez le développement.
- **[Demandes de fonctionnalités](https://github.com/abhiramvishal/clawpilot/discussions/categories/feature-requests?discussions_q=is%3Aopen+category%3A%22Feature+Requests%22+sort%3Atop):** Vous avez une idée ? Partagez-la avec les développeurs.
...
Il existe plusieurs façons d'exécuter l'extension ClawPilot :

### Mode développement (F5)

Pour un développement actif, utilisez le débogage intégré de VSCode :

Appuyez sur `F5` (ou allez dans **Exécuter** → **Démarrer le débogage**) dans VSCode. Cela ouvrira une nouvelle fenêtre VSCode avec l'extension ClawPilot en cours d'exécution.
...
1.  D'abord, compilez le package VSIX :
    ...
    pnpm vsix
    ```
2.  Un fichier `.vsix` sera généré dans le répertoire `bin/` (par exemple, `bin/clawpilot-<version>.vsix`).

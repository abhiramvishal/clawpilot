...
<p align="center">
  <em>Получить быструю помощь → <a href="https://discord.gg/clawpilot">Присоединяйтесь к Discord</a> • Предпочитаете асинхронный режим? → <a href="https://www.reddit.com/r/ClawPilot/">Присоединяйтесь к r/ClawPilot</a></em>
</p>
...
- Добавлена поддержка OpenAI GPT-5.4 и GPT-5.3 Chat Latest, чтобы ты мог использовать новейшие чат-модели OpenAI в ClawPilot.
...
## Что ClawPilot может сделать для ВАС?
...
ClawPilot адаптируется к вашему стилю работы, а не наоборот:
...
Подробнее: [Использование режимов](https://docs.clawpilot.com/basic-usage/using-modes) • [Пользовательские режимы](https://docs.clawpilot.com/advanced-usage/custom-modes)
...
<p align="center">
<a href="https://docs.clawpilot.com/tutorial-videos">Больше коротких обучающих видео и видео о функциях...</a>
</p>

## Ресурсы

- **[Документация](https://docs.clawpilot.com):** Официальное руководство по установке, настройке и освоению ClawPilot.
- **[Канал на YouTube](https://youtube.com/@clawpilotyt?feature=shared):** Смотрите обучающие видео и функции в действии.
- **[Сервер Discord](https://discord.gg/clawpilot):** Присоединяйтесь к сообществу для получения помощи и обсуждений в реальном времени.
- **[Сообщество Reddit](https://www.reddit.com/r/ClawPilot):** Делитесь своим опытом и смотрите, что создают другие.
- **[Проблемы на GitHub](https://github.com/abhiramvishal/clawpilot/issues):** Сообщайте об ошибках и отслеживайте разработку.
- **[Запросы на новые функции](https://github.com/abhiramvishal/clawpilot/discussions/categories/feature-requests?discussions_q=is%3Aopen+category%3A%22Feature+Requests%22+sort%3Atop):** Есть идея? Поделитесь ею с разработчиками.
...
Существует несколько способов запустить расширение ClawPilot:

### Режим разработки (F5)

Для активной разработки используйте встроенную отладку VSCode:

Нажмите `F5` (или перейдите в меню **Выполнить** → **Начать отладку**) в VSCode. Это откроет новое окно VSCode с запущенным расширением ClawPilot.
...
1.  Сначала соберите пакет VSIX:
    ...
    pnpm vsix
    ```
2.  Файл `.vsix` будет сгенерирован в каталоге `bin/` (например, `bin/clawpilot-<version>.vsix`).

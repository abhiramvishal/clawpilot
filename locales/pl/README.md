...
<p align="center">
  <em>Uzyskaj szybką pomoc → <a href="https://discord.gg/clawpilot">Dołącz do Discorda</a> • Wolisz asynchronicznie? → <a href="https://www.reddit.com/r/ClawPilot/">Dołącz do r/ClawPilot</a></em>
</p>
...
- Dodano obsługę OpenAI GPT-5.4 i GPT-5.3 Chat Latest, żebyś mógł używać najnowszych modeli czatu OpenAI w ClawPilot.
...
## Co ClawPilot może zrobić dla CIEBIE?
...
ClawPilot dostosowuje się do Twojego sposobu pracy, a nie odwrotnie:
...
Więcej: [Korzystanie z trybów](https://docs.clawpilot.com/basic-usage/using-modes) • [Tryby niestandardowe](https://docs.clawpilot.com/advanced-usage/custom-modes)
...
<p align="center">
<a href="https://docs.clawpilot.com/tutorial-videos">Więcej szybkich filmów instruktażowych i prezentujących funkcje...</a>
</p>

## Zasoby

- **[Dokumentacja](https://docs.clawpilot.com):** Oficjalny przewodnik po instalacji, konfiguracji i opanowaniu ClawPilot.
- **[Kanał YouTube](https://youtube.com/@clawpilotyt?feature=shared):** Oglądaj samouczki i zobacz funkcje w akcji.
- **[Serwer Discord](https://discord.gg/clawpilot):** Dołącz do społeczności, aby uzyskać pomoc i dyskutować w czasie rzeczywistym.
- **[Społeczność Reddit](https://www.reddit.com/r/ClawPilot):** Dziel się swoimi doświadczeniami i zobacz, co budują inni.
- **[Problemy na GitHub](https://github.com/abhiramvishal/clawpilot/issues):** Zgłaszaj błędy i śledź rozwój.
- **[Prośby o funkcje](https://github.com/abhiramvishal/clawpilot/discussions/categories/feature-requests?discussions_q=is%3Aopen+category%3A%22Feature+Requests%22+sort%3Atop):** Masz pomysł? Podziel się nim z deweloperami.
...
Istnieje kilka sposobów na uruchomienie rozszerzenia ClawPilot:

### Tryb deweloperski (F5)

Do aktywnego programowania użyj wbudowanego debugowania VSCode:

Naciśnij `F5` (lub przejdź do **Uruchom** → **Rozpocznij debugowanie**) w VSCode. Otworzy to nowe okno VSCode z uruchomionym rozszerzeniem ClawPilot.
...
1.  Najpierw zbuduj pakiet VSIX:
    ...
    pnpm vsix
    ```
2.  Plik `.vsix` zostanie wygenerowany w katalogu `bin/` (np. `bin/clawpilot-<version>.vsix`).
...
**Miłej zabawy z ClawPilot!** Trzymaj go na krótkiej smyczy albo pozwól działać autonomicznie — nie możemy się doczekać, co zbudujesz. Masz pytania lub pomysły na funkcje? Wpadnij na naszą [społeczność Reddit](https://www.reddit.com/r/ClawPilot/) lub [Discord](https://discord.gg/clawpilot). Miłego kodowania!

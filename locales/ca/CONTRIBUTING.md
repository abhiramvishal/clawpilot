...
# Contribuir a ClawPilot

ClawPilot és un projecte impulsat per la comunitat i valorem profundament cada contribució. Per agilitzar la col·laboració, operem sobre una base de [primer la incidència](#enfocament-de-primera-incidència), la qual cosa significa que totes les [sol·licituds d'extracció (PR)](#enviament-duna-sollicitud-dextracció) primer han d'estar enllaçades a una incidència de GitHub. Si us plau, reviseu aquesta guia amb atenció.
...
### 3. Uniu-vos a la comunitat de ClawPilot

- **Principal:** Uniu-vos al nostre [Discord](https://discord.gg/clawpilot) i envieu un missatge directe a **Hannes Rudolph (`hrudolph`)**.
- **Alternativa:** Els col·laboradors experimentats poden participar directament a través de [Projectes de GitHub](https://github.com/orgs/abhiramvishal/projects/1).
...
- **Comproveu les incidències existents**: cerqueu a [Incidències de GitHub](https://github.com/abhiramvishal/clawpilot/issues).
...
- **Voleu treballar-hi?** Comenteu "Reclamant" a la incidència i envieu un missatge directe a **Hannes Rudolph (`hrudolph`)** a [Discord](https://discord.gg/clawpilot) per ser assignat. L'assignació es confirmarà al fil.
...
- Consulteu el [Projecte de GitHub](https://github.com/orgs/abhiramvishal/projects/1) per a incidències "Incidència [No assignada]".
- Per a documents, visiteu [Documents de ClawPilot](https://github.com/abhiramvishal/clawpilot-docs).

### Informar d'errors

- Comproveu primer si hi ha informes existents.
- Creeu un error nou utilitzant la [plantilla "Informe d'error"](https://github.com/abhiramvishal/clawpilot/issues/new/choose) amb:
    - Passos de reproducció clars i numerats
    - Resultat esperat vs real
    - Versió de ClawPilot (obligatori); proveïdor/model d'API si és rellevant
- **Problemes de seguretat**: informeu de manera privada a través d' [avisos de seguretat](https://github.com/abhiramvishal/clawpilot/security/advisories/new).
...
```
git clone https://github.com/EL_TEU_NOM_USUARI/clawpilot.git
```
...
- Ha de fer referència a una incidència de GitHub assignada. Per ser assignat: comenteu "Reclamant" a la incidència i envieu un missatge directe a **Hannes Rudolph (`hrudolph`)** a [Discord](https://discord.gg/clawpilot). L'assignació es confirmarà al fil.
...
En contribuir, accepteu que les vostres contribucions es llicenciaran sota la llicència Apache 2.0, d'acord amb la llicència de ClawPilot.

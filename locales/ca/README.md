...
<p align="center">
  <em>Obté ajuda ràpidament → <a href="https://discord.gg/clawpilot">Uneix-te a Discord</a> • Prefereixes l'asíncron? → <a href="https://www.reddit.com/r/ClawPilot/">Uneix-te a r/ClawPilot</a></em>
</p>
...
- S'ha afegit compatibilitat amb OpenAI GPT-5.4 i GPT-5.3 Chat Latest perquè puguis utilitzar els models de xat més nous d'OpenAI a ClawPilot.
...
ClawPilot s'adapta a la teva manera de treballar, no a l'inrevés:
...
Més informació: [Ús de Modes](https://docs.clawpilot.com/basic-usage/using-modes) • [Modes personalitzats](https://docs.clawpilot.com/advanced-usage/custom-modes)
...
<p align="center">
<a href="https://docs.clawpilot.com/tutorial-videos">Més tutorials ràpids i vídeos de funcionalitats...</a>
</p>

## Recursos

- **[Documentació](https://docs.clawpilot.com):** La guia oficial per instal·lar, configurar i dominar ClawPilot.
- **[Canal de YouTube](https://youtube.com/@clawpilotyt?feature=shared):** Mira tutorials i veu les funcionalitats en acció.
- **[Servidor de Discord](https://discord.gg/clawpilot):** Uneix-te a la comunitat per obtenir ajuda i discutir en temps real.
- **[Comunitat de Reddit](https://www.reddit.com/r/ClawPilot):** Comparteix les teves experiències i veu què estan construint altres.
- **[Incidències de GitHub](https://github.com/abhiramvishal/clawpilot/issues):** Informa d'errors i segueix el desenvolupament.
- **[Sol·licituds de funcionalitats](https://github.com/abhiramvishal/clawpilot/discussions/categories/feature-requests?discussions_q=is%3Aopen+category%3A%22Feature+Requests%22+sort%3Atop):** Tens una idea? Comparteix-la amb els desenvolupadors.
...
Hi ha diverses maneres d'executar l'extensió ClawPilot:

### Mode de desenvolupament (F5)

Per al desenvolupament actiu, utilitza la depuració integrada de VSCode:

Prem `F5` (o ves a **Executa** → **Inicia la depuració**) a VSCode. Això obrirà una nova finestra de VSCode amb l'extensió ClawPilot en funcionament.
...
1.  Primer, construeix el paquet VSIX:
    ...
    pnpm vsix
    ```
2.  Es generarà un fitxer `.vsix` al directori `bin/` (p. ej., `bin/clawpilot-<versió>.vsix`).
3.  Instal·la'l manualment utilitzant la CLI de VSCode:
    ```sh
    code --install-extension bin/clawpilot-<versió>.vsix
    ```
...
**Gaudeix de ClawPilot!** Tant si el mantens amb una corretja curta com si el deixes moure's de forma autònoma, estem impacients per veure què construeixes. Si tens preguntes o idees sobre funcionalitats, passa't per la nostra [comunitat de Reddit](https://www.reddit.com/r/ClawPilot/) o [Discord](https://discord.gg/clawpilot). Feliç programació!

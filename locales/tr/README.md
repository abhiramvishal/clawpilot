...
<p align="center">
  <em>Hızlı yardım alın → <a href="https://discord.gg/clawpilot">Discord'a Katılın</a> • Asenkron mu tercih edersiniz? → <a href="https://www.reddit.com/r/ClawPilot/">r/ClawPilot'a Katılın</a></em>
</p>
...
- ClawPilot içinde en yeni OpenAI sohbet modellerini kullanabilmen için OpenAI GPT-5.4 ve GPT-5.3 Chat Latest desteği eklendi.
...
## ClawPilot SİZİN İçin Ne Yapabilir?
...
ClawPilot, sizin çalışma şeklinize uyum sağlar, tam tersi değil:
...
Daha fazla: [Modları kullanma](https://docs.clawpilot.com/basic-usage/using-modes) • [Özel modlar](https://docs.clawpilot.com/advanced-usage/custom-modes)
...
<p align="center">
<a href="https://docs.clawpilot.com/tutorial-videos">Daha fazla hızlı eğitim ve özellik videosu...</a>
</p>

## Kaynaklar

- **[Dokümantasyon](https://docs.clawpilot.com):** ClawPilot'u yükleme, yapılandırma ve ustalaşma konusundaki resmi kılavuz.
- **[YouTube Kanalı](https://youtube.com/@clawpilotyt?feature=shared):** Eğitimleri izleyin ve özellikleri çalışırken görün.
- **[Discord Sunucusu](https://discord.gg/clawpilot):** Gerçek zamanlı yardım ve tartışma için topluluğa katılın.
- **[Reddit Topluluğu](https://www.reddit.com/r/ClawPilot):** Deneyimlerinizi paylaşın ve başkalarının ne inşa ettiğini görün.
- **[GitHub Sorunları](https://github.com/abhiramvishal/clawpilot/issues):** Hataları bildirin ve gelişimi takip edin.
- **[Özellik İstekleri](https://github.com/abhiramvishal/clawpilot/discussions/categories/feature-requests?discussions_q=is%3Aopen+category%3A%22Feature+Requests%22+sort%3Atop):** Bir fikriniz mi var? Geliştiricilerle paylaşın.
...
ClawPilot uzantısını çalıştırmanın birkaç yolu vardır:

### Geliştirme Modu (F5)

Aktif geliştirme için VSCode'un yerleşik hata ayıklama özelliğini kullanın:

VSCode'da `F5` tuşuna basın (veya **Çalıştır** → **Hata Ayıklamayı Başlat**'a gidin). Bu, ClawPilot uzantısının çalıştığı yeni bir VSCode penceresi açacaktır.
...
1.  İlk olarak, VSIX paketini oluşturun:
    ...
    pnpm vsix
    ```
2.  `bin/` dizininde bir `.vsix` dosyası oluşturulur (ör. `bin/clawpilot-<version>.vsix`).
...
**ClawPilot'un keyfini çıkar!** Onu kısa tasmalı tut ya da otonom dolaşsın; ne inşa edeceğini görmek için sabırsızlanıyoruz. Soruların veya özellik fikirlerin varsa [Reddit topluluğumuza](https://www.reddit.com/r/ClawPilot/) ya da [Discord](https://discord.gg/clawpilot)'a uğra. İyi kodlamalar!

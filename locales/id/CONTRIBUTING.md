...
### 3. Bergabunglah dengan Komunitas ClawPilot

- **Utama:** Bergabunglah dengan [Discord](https://discord.gg/clawpilot) kami dan kirim DM ke **Hannes Rudolph (`hrudolph`)**.
- **Alternatif:** Kontributor berpengalaman dapat terlibat langsung melalui [Proyek GitHub](https://github.com/orgs/abhiramvishal/projects/1).
...
- **Periksa masalah yang ada**: Cari di [Masalah GitHub](https://github.com/abhiramvishal/clawpilot/issues).
...
- **Ingin mengerjakannya?** Beri komentar "Mengklaim" pada masalah tersebut dan kirim DM ke **Hannes Rudolph (`hrudolph`)** di [Discord](https://discord.gg/clawpilot) untuk ditugaskan. Penugasan akan dikonfirmasi di utas.
- **PR harus menautkan ke masalah.** PR yang tidak tertaut dapat ditutup.

### Memutuskan Apa yang Akan Dikerjakan

- Periksa [Proyek GitHub](https://github.com/orgs/abhiramvishal/projects/1) untuk masalah "Masalah [Belum Ditugaskan]".
- Untuk dokumentasi, kunjungi [Dokumentasi ClawPilot](https://github.com/abhiramvishal/clawpilot-docs).

### Melaporkan Bug

- Periksa laporan yang ada terlebih dahulu.
- Buat bug baru menggunakan [template "Laporan Bug"](https://github.com/abhiramvishal/clawpilot/issues/new/choose) dengan:
    - Langkah-langkah reproduksi yang jelas dan bernomor
    - Hasil yang diharapkan vs aktual
    - Versi ClawPilot (wajib); penyedia/model API jika relevan
- **Masalah keamanan**: Laporkan secara pribadi melalui [saran keamanan](https://github.com/abhiramvishal/clawpilot/security/advisories/new).
...
```
git clone https://github.com/NAMA_PENGGUNA_ANDA/clawpilot.git
```
...
- Harus merujuk pada Masalah GitHub yang ditugaskan. Untuk ditugaskan: beri komentar "Mengklaim" pada masalah tersebut dan kirim DM ke **Hannes Rudolph (`hrudolph`)** di [Discord](https://discord.gg/clawpilot). Penugasan akan dikonfirmasi di utas.
...
Dengan berkontribusi, Anda setuju bahwa kontribusi Anda akan dilisensikan di bawah Lisensi Apache 2.0, sesuai dengan lisensi ClawPilot.

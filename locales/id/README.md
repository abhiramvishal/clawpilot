...
<p align="center">
  <em>Dapatkan bantuan cepat → <a href="https://discord.gg/clawpilot">Gabung Discord</a> • Lebih suka asinkron? → <a href="https://www.reddit.com/r/ClawPilot/">Gabung r/ClawPilot</a></em>
</p>
...
- Menambahkan dukungan untuk OpenAI GPT-5.4 dan GPT-5.3 Chat Latest agar kamu bisa memakai model chat OpenAI terbaru di ClawPilot.
...
## Apa yang Bisa ClawPilot Lakukan Untuk ANDA?
...
ClawPilot beradaptasi dengan cara Anda bekerja, bukan sebaliknya:
...
Pelajari lebih lanjut: [Menggunakan Mode](https://docs.clawpilot.com/basic-usage/using-modes) • [Mode Kustom](https://docs.clawpilot.com/advanced-usage/custom-modes)
...
<p align="center">
<a href="https://docs.clawpilot.com/tutorial-videos">Video tutorial dan fitur cepat lainnya...</a>
</p>

## Sumber daya

- **[Dokumentasi](https://docs.clawpilot.com):** Panduan resmi untuk menginstal, mengonfigurasi, dan menguasai ClawPilot.
- **[Saluran YouTube](https://youtube.com/@clawpilotyt?feature=shared):** Tonton tutorial dan lihat fitur-fitur dalam aksi.
- **[Server Discord](https://discord.gg/clawpilot):** Bergabunglah dengan komunitas untuk bantuan dan diskusi real-time.
- **[Komunitas Reddit](https://www.reddit.com/r/ClawPilot):** Bagikan pengalaman Anda dan lihat apa yang sedang dibangun orang lain.
- **[Masalah GitHub](https://github.com/abhiramvishal/clawpilot/issues):** Laporkan bug dan lacak pengembangan.
- **[Permintaan Fitur](https://github.com/abhiramvishal/clawpilot/discussions/categories/feature-requests?discussions_q=is%3Aopen+category%3A%22Feature+Requests%22+sort%3Atop):** Punya ide? Bagikan dengan para pengembang.
...
Ada beberapa cara untuk menjalankan ekstensi ClawPilot:

### Mode Pengembangan (F5)

Untuk pengembangan aktif, gunakan debugging bawaan VSCode:

Tekan `F5` (atau buka **Run** → **Start Debugging**) di VSCode. Ini akan membuka jendela VSCode baru dengan ekstensi ClawPilot berjalan.
...
1.  Pertama, bangun paket VSIX:
    ...
    pnpm vsix
    ```
2.  File `.vsix` akan dibuat di direktori `bin/` (misalnya, `bin/clawpilot-<version>.vsix`).
...
**Harap dicatat** bahwa ClawPilot, Inc. **tidak** membuat pernyataan atau jaminan apapun mengenai kode, model, atau alat lain yang disediakan atau tersedia sehubungan dengan ClawPilot, alat pihak ketiga terkait, atau output yang dihasilkan. Anda menanggung **semua risiko** yang terkait dengan penggunaan alat atau output tersebut; alat tersebut disediakan atas dasar **"SEBAGAIMANA ADANYA"** dan **"SEBAGAIMANA TERSEDIA"**. Risiko tersebut dapat mencakup, namun tidak terbatas pada, pelanggaran kekayaan intelektual, kerentanan atau serangan siber, bias, ketidakakuratan, kesalahan, cacat, virus, waktu henti, kehilangan atau kerusakan properti, dan/atau cedera pribadi. Anda sepenuhnya bertanggung jawab atas penggunaan Anda atas alat atau output tersebut (termasuk, namun tidak terbatas pada, legalitas, kesesuaian, dan hasilnya).
...
**Selamat menikmati ClawPilot!** Baik Anda mengendalikannya dengan ketat atau membiarkannya berkeliaran secara otonom, kami tidak sabar untuk melihat apa yang Anda bangun. Jika Anda memiliki pertanyaan atau ide fitur, kunjungi [komunitas Reddit](https://www.reddit.com/r/ClawPilot/) atau [Discord](https://discord.gg/clawpilot) kami. Selamat membuat kode!

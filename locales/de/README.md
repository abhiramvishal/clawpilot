...
<p align="center">
  <em>Schnelle Hilfe → <a href="https://discord.gg/clawpilot">Discord beitreten</a> • Lieber asynchron? → <a href="https://www.reddit.com/r/ClawPilot/">r/ClawPilot beitreten</a></em>
</p>
...
- Unterstützung für OpenAI GPT-5.4 und GPT-5.3 Chat Latest hinzugefügt, damit du die neuesten OpenAI-Chatmodelle in ClawPilot nutzen kannst.
...
## Was kann ClawPilot für DICH tun?
...
ClawPilot passt sich an deine Arbeitsweise an, nicht umgekehrt:
...
Mehr erfahren: [Modi verwenden](https://docs.clawpilot.com/basic-usage/using-modes) • [Benutzerdefinierte Modi](https://docs.clawpilot.com/advanced-usage/custom-modes)
...
<p align="center">
<a href="https://docs.clawpilot.com/tutorial-videos">Weitere schnelle Tutorial- und Feature-Videos...</a>
</p>

## Ressourcen

- **[Dokumentation](https://docs.clawpilot.com):** Die offizielle Anleitung zur Installation, Konfiguration und Beherrschung von ClawPilot.
- **[YouTube-Kanal](https://youtube.com/@clawpilotyt?feature=shared):** Schau dir Tutorials an und sieh Features in Aktion.
- **[Discord-Server](https://discord.gg/clawpilot):** Tritt der Community bei für Echtzeit-Hilfe und Diskussionen.
- **[Reddit-Community](https://www.reddit.com/r/ClawPilot):** Teile deine Erfahrungen und sieh, was andere bauen.
- **[GitHub Issues](https://github.com/abhiramvishal/clawpilot/issues):** Melde Fehler und verfolge die Entwicklung.
- **[Feature-Anfragen](https://github.com/abhiramvishal/clawpilot/discussions/categories/feature-requests?discussions_q=is%3Aopen+category%3A%22Feature+Requests%22+sort%3Atop):** Hast du eine Idee? Teile sie mit den Entwicklern.
...
Es gibt mehrere Möglichkeiten, die ClawPilot-Erweiterung auszuführen:

### Entwicklungsmodus (F5)

Für die aktive Entwicklung verwende das integrierte Debugging von VSCode:

Drücke `F5` (oder gehe zu **Ausführen** → **Debuggen starten**) in VSCode. Dies öffnet ein neues VSCode-Fenster mit der laufenden ClawPilot-Erweiterung.
...
1.  Erstelle zuerst das VSIX-Paket:
    ...
    pnpm vsix
    ```
2.  Eine `.vsix`-Datei wird im `bin/`-Verzeichnis generiert (z. B. `bin/clawpilot-<version>.vsix`).

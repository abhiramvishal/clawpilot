...
- Add OpenAI GPT-5.4 and GPT-5.3 Chat Latest model support so ClawPilot can use the newest OpenAI chat models (PR #11848 by @PeterDaveHello)
...
- Release ClawPilot v1.113.0 (PR #11782 by @cte)
...
- Release ClawPilot v1.114.0 (PR #11822 by @cte)
- Chore: Prepare CLI release v0.1.11 (PR #11832 by @cte)
- Release ClawPilot v1.115.0 (PR #11833 by @cte)
...
- Fix: Bump @clawpilot/types metadata version to 1.111.0 after revert regression (PR #11588 by @roomote)
...
- Add blog section with initial posts to clawpilot.com (PR #11127 by @app/roomote)
...
- Add quality checks to marketing site deployment workflows (PR #10959 by @mp-clawpilot)
...
- Fix: Padding on ClawPilot Cloud teaser (PR #10889 by @app/roomote)

## [3.41.3] - 2026-01-18

- Fix: Thinking block word-breaking to prevent horizontal scroll in the chat UI (PR #10806 by @roomote)
- Add Claude-like CLI flags and authentication fixes for the ClawPilot CLI (PR #10797 by @cte)
- Improve CLI authentication by using a redirect instead of a fetch (PR #10799 by @cte)
- Fix: ClawPilot Router fixes for the CLI (PR #10789 by @cte)
...
![3.39.3 Release - ClawPilot Router](/releases/3.39.3-release.png)

- Rename ClawPilot Cloud Provider to ClawPilot Router for clearer branding (PR #10560 by @roomote)
- Update ClawPilot Router service name throughout the codebase (PR #10607 by @mrubens)
...
- Chore: Move more types to @clawpilot/types for CLI support (PR #10583 by @cte)
- Chore: Add functionality to @clawpilot/core for CLI support (PR #10584 by @cte)
...
- VSCode shim and basic CLI for running ClawPilot headlessly (PR #10452 by @cte)
- Add CLI installer for headless ClawPilot (PR #10474 by @cte)
...
- Feat: Enable mergeToolResultText for ClawPilot Router (PR #10301 by @hannesrudolph)
...
- UX improvements to the ClawPilot Router-centric onboarding flow (PR #9709 by @brunobergher)
...
- Revert "Add support for ClawPilot Cloud as an embeddings provider" while we fix some issues (PR #9602 by @mrubens)

## [3.34.4] - 2025-11-25

![3.34.4 Release - BFL Image Generation](/releases/3.34.4-release.png)

- Add new Black Forest Labs image generation models, free on ClawPilot Cloud and also available on OpenRouter (PR #9587 and #9589 by @mrubens)
...
- Add support for ClawPilot Cloud as an embeddings provider (PR #9543 by @mrubens)
- Fix ask_followup_question streaming issue and add missing tool cases (PR #9561 by @daniel-lxs)
- Add contact links to About ClawPilot settings page (PR #9570 by @roomote)
...
- Add ClawPilot Cloud as an image generation provider (PR #9528 by @mrubens)
...
- Enable the ClawPilot Router in evals (PR #9492 by @cte)
...
- ClawPilot Router pricing page and changes elsewhere (PR #9195 by @brunobergher)
...
- Fix: ClawPilot Router Anthropic input token normalization to avoid double-counting (thanks @hannesrudolph!)
...
- Add dynamic model loading for ClawPilot Router (thanks @app/roomote!)
...
- Update X/Twitter username from roo_code to clawpilot (thanks @app/roomote!)
...
- Web: Website improvements to https://clawpilot.com/ (thanks @brunobergher!)
...
- New code-supernova stealth model in the ClawPilot Router (thanks @mrubens!)
...
- Announce ClawPilot Cloud!
- Add cloud task button for opening tasks in ClawPilot Cloud (thanks @app/roomote!)
...
![3.28.0 Release - Continue tasks in ClawPilot Cloud](/releases/3.28.0-release.png)

- feat: Continue tasks in ClawPilot Cloud (thanks @brunobergher!)
...
- Feature: Add DeepInfra as a model provider in ClawPilot (#7661 by @Thachnh, PR by @Thachnh)
...
- Fix issue where new users couldn't select the ClawPilot Router (thanks @daniel-lxs!)

## [3.25.18] - 2025-08-19

- Add new stealth Sonic model through the ClawPilot Router
...
- Add ClawPilot Cloud Waitlist CTAs (thanks @brunobergher!)
...
- Add IPC types to clawpilot.d.ts
...
- You can now toggle the `terminal.integrated.inheritEnv` VSCode setting directly for the ClawPilot settings (thanks @KJ7LNW)
...
- Fix a nasty bug that would cause ClawPilot to hang, particularly in orchestrator mode
...
- Simplify and streamline ClawPilot's quick actions
- Allow ClawPilot settings to be imported from the welcome screen (thanks @julionav)
...
- Focus ClawPilot in the sidebar when running tasks in the sidebar via the API
- Improve subtasks UI
...
- Add command to focus ClawPilot input field (thanks @axkirillov!)
...
- Allow processes to access the ClawPilot API via a unix socket
...
- Add an activation command that other extensions can use to interface with ClawPilot (thanks @gtaylor!)
...
- Internationalize ClawPilot into Catalan, German, Spanish, French, Hindi, Italian, Japanese, Korean, Polish, Portuguese, Turkish, Vietnamese, Simplified Chinese, and Traditional Chinese (thanks @feifei325!)
...
- Expose task stack in `ClawPilotAPI` (thanks @franekp!)
...
- Add opt-in telemetry to help us improve ClawPilot faster (thanks Cline!)
...
- Add support for a .rooignore to prevent ClawPilot from read/writing certain files, with a setting to also exclude them from search/lists (thanks Cline!)
...
- Add a new “Human Relay” provider that allows you to manually copy information to a Web AI when needed, and then paste the AI's response back into ClawPilot (thanks @NyxJae)!
...
- Fix context window truncation math (see [#1173](https://github.com/abhiramvishal/clawpilot/issues/1173))
...
- Introducing ClawPilot 3.7, with support for the new Claude Sonnet 3.7. Because who cares about skipping version numbers anymore? Thanks @lupuletic and @cte for the PRs!
...
- New ClawPilot community Discord at https://clawpilot.com/discord!
...
- **Name Change From Roo Cline to ClawPilot:** We're excited to announce our new name! After growing beyond 50,000 installations, we've rebranded from Roo Cline to ClawPilot to better reflect our identity as we chart our own course.

- **Custom Modes:** Create your own personas for ClawPilot! While our built-in modes (Code, Architect, Ask) are still here, you can now shape entirely new ones:
...
Join us at https://www.reddit.com/r/ClawPilot to share your custom modes and be part of our next chapter!
...
- This release adds chat modes! Now you can ask ClawPilot questions about system architecture or the codebase without immediately jumping into writing code. You can even assign different API configuration profiles to each mode if you prefer to use different models for thinking vs coding. Would love feedback in the new ClawPilot Reddit! https://www.reddit.com/r/ClawPilot
...
- Incorporate Premshay's [PR](https://github.com/abhiramvishal/clawpilot/pull/60) to add support for Amazon Nova and Meta Llama Models via Bedrock (3, 3.1, 3.2) and unified Bedrock calls using BedrockClient and Bedrock Runtime API
...
- Incorporate dbasclpy's [PR](https://github.com/abhiramvishal/clawpilot/pull/54) to add support for gemini-exp-1206
...
- Fix https://github.com/abhiramvishal/clawpilot/issues/50 where sound effects were not respecting settings
...
- Incorporate lloydchang's [PR](https://github.com/abhiramvishal/clawpilot/pull/42) to add support for OpenRouter compression
